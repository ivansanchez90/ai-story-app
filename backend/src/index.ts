...
El usuario está en el turno ${currentTurn || 1} de un máximo de 8.
...
3. Si el turno es menor a 8, devuelve entre 2 y 3 opciones.
4. Si el turno actual es 8 o si la historia llega a un final natural, termina definitivamente.
